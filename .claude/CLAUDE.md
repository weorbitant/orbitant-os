...
├── plugins/
│   ├── orbitant-marketing/         <- v1.8.2 — blog-post-review, blog-post-create, blog-post-translate, tone, yt-description, linkedin-post, image-creation, newsletter, x-thread, x-post
│   │   ├── .claude-plugin/
│   │   │   └── plugin.json
│   │   └── skills/
...
|--------|---------|--------|--------|----------|
| orbitant-marketing | 1.8.2 | Active | `orbitant-blog-post-review`, `orbitant-blog-post-create`, `orbitant-blog-post-translate`, `orbitant-tone`, `orbitant-yt-description`, `orbitant-linkedin-post`, `orbitant-image-creation`, `orbitant-newsletter`, `orbitant-x-thread`, `orbitant-x-post` | — |
